        ...
        <div className="nav-content">
          ...
          <div className="nav-links desktop-nav">
            {['About', 'Experience', 'Projects', 'Skills', 'Contact'].map((item) => (
              ...
              >
                <span className="nav-number">0{['About', 'Experience', 'Projects', 'Skills', 'Contact'].indexOf(item) + 1}</span>
                {item}
              </button>
            ))}
          </div>
            ...
            <div className="experience-card">
              <div className="experience-header">
                ...
                <div className="experience-title-row">
                  ...
                  <span className="experience-company">VIEntityData Technologies</span>
                </div>
              </div>
              <div className="experience-body">
                <p className="experience-description">
                  Working as a Frontend Developer Intern building responsive, high-performance web interfaces 
                  for AI-powered recruitment and healthcare platforms. Contributed to REST API integrations, 
                  Razorpay payment gateway implementation, and developed multiple product features 
                  across AI assessment, AI interview, and resume-building tools. Also independently built 
                  a healthcare website serving users outside the organization.
                </p>

                <div className="experience-contributions">
                  <h4 className="experience-projects-title">Key Contributions</h4>
                  <div className="experience-tags">
                    <span className="exp-tag">API Integration</span>
                    <span className="exp-tag">Razorpay Integration</span>
                    <span className="exp-tag">AI Assessment Platform</span>
                    <span className="exp-tag">AI Interview Platform</span>
                    <span className="exp-tag">Resume Builder</span>
                    <span className="exp-tag">Healthcare Website</span>
                  </div>
                </div>

                <div className="experience-projects">
                  <h4 className="experience-projects-title">Live Projects</h4>
                  <div className="experience-project-links">
                    ...
                    >
                      ...
                      <div className="ep-info">
                        <span className="ep-name">intellihires.in</span>
                        <span className="ep-desc">AI hiring & assessment platform</span>
                      </div>
                    </a>
                    <a 
                    ...
                    >
                      <span className="ep-icon">↗</span>
                      <div className="ep-info">
                        <span className="ep-name">ai.intellirecruits.com</span>
                        <span className="ep-desc">AI interview & recruitment system</span>
                      </div>
                    </a>
                  </div>
                </div>
